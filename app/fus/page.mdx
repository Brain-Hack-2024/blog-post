...
By: [Raffi Hotter](https://rhotter.com/), [Vincent Huang](https://www.vvhuang.com/), [Brian Machado](https://twitter.com/sincethestudy), Thomas Ribeiro, and [Anson Yu](https://ansonyu.me/)
</div>
...
<div className="w-full lg:w-screen lg:-ml-[calc(50vw-50%)] flex justify-center">
...
- [Hunter Davis](https://twitter.com/huntercoledavis), [David Garrett](https://twitter.com/david_c_garrett), [Sumner Norman](https://twitter.com/SumnerLN), David Maresca, and [Hari Kumar](https://twitter.com/Harie1897) for technical advice
