...
By: [Vincent Huang](https://www.vvhuang.com/), [Raffi Hotter](https://rhotter.com/), [Brian Machado](https://twitter.com/sincethestudy), Thomas Ribeiro, and [Anson Yu](https://ansonyu.me/)
</div>
...
<Image src={bannerImg} alt="Banner image showing functional ultrasound through the skull" />
...
Aberrations in the body come from changes in the speed of sound, similar to how light bends in Snell's law. There are two problems here
...
We built our own syringe pump. Blood travels at around \~10 mm/s in small vessels in the brain ([ref](https://www.ncbi.nlm.nih.gov/pmc/articles/PMC6610068/#:~:text=RBC%20speed%20reaches%202%E2%80%933,s%20in%20larger%20pial%20vessels.)), so we wanted our pump to have similar speeds. Initially we planned on using a peristaltic pump, however we could not source one that had a small enough volumetric flow rate, and at slow speeds peristaltic pumps flow rate is not consistent. 
...
- [Hunter Davis](https://twitter.com/huntercoledavis), [David Garrett](https://twitter.com/david_c_garrett), [Sumner Norman](https://twitter.com/SumnerLN), Jean Provost, and [Hari Kumar](https://twitter.com/Harie1897) for technical advice
- [Leo Zaroff](https://twitter.com/leozaroff) for lending us his hydrophone