...
](https://linearaudio.net/low-noise-laboratory-grade-measurement-preamplifier)</div>The more fundamental bound of our noise floor comes from Johnson noise in the brain and skull itself. The skull has a resistivity of about [$1000 \, \Omega \cdot \text{cm}$](https://www.sciencedirect.com/science/article/abs/pii/S138824570400327X), which translates to a Johnson noise of about $5 \text{ nV}/\sqrt{\text{Hz}}$. Assuming a bandwidth of 10 Hz, this gives a noise floor of 16 nV, which would make the AE signal just barely detectable.
