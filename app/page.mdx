...
Currently, noninvasive devices are extremely limited in their spatial resolution. EEG can localize brain activity to about <span class="threecm">3cm</span> spatial regions, due to smearing of potentials*.<div class="annotation">
...
Data was obtained by looking at the difference frequency (500 kHz minus 135.145 kHz*), <div class="annotation">* We chose this frequency arbitrarily, but also tested lower frequencies (200 Hz) later.</div> sweeping the lock-in frequency between 499,760 and 499,770 Hz. The amplitude of the AE effect was taken to be the peak within the range:
