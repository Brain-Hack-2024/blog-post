<div class="max-w-2xl md:ml-[20vw] ml-0 mt-16 md:mt-24 mb-36 px-4 overflow-clip md:overflow-visible">
...
<img src="https://io0-questions.s3.us-west-2.amazonaws.com/2024/dfbdd8064e57cf8f50553a05d052d635.png"/>
</div>
<div class="radio">
...
Data was obtained by looking at the difference frequency (500 kHz - 135.145 kHz*), <div class="annotation">* We chose this frequency arbitrarily, but also tested lower frequencies (200 Hz) later.</div> sweeping the lock-in frequency between 499,760 and 499,770 Hz. The amplitude of the AE effect was taken to be the peak within the range:
...
<div class="column">
<div class="note">
<div class="interlude">Interlude: speed of sound</div>
