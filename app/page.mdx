...
# We have AE at home
<div class="author">By: Andy Kong, Brian Machado, Ethan Childerhose, Kevin Chung, Marley Xiong</div>
...
Currently, noninvasive devices are extremely limited in their spatial resolution. EEG can localize brain activity to about <span className="threecm">3cm</span> spatial regions, due to the smearing of potentials*.<div className="annotation"></div>
...
where $k = 1 \times 10^{-9} \, \text{Pa}^{-1}$. This corresponds to a modulation of 0.1% per MPa of pressure, in the case of an ideal plane wave.
